...
urlpatterns = patterns('',
    ...
    url(r'dashboard/interests/$', 'remo.base.views.dashboard_mozillians',
        name='mozillians_interests'),
    ...
    url(r'labs/$', direct_to_template, {'template': 'labs.html'},
        name='labs'),
    url(r'dashboard_mockup/$', direct_to_template,
        {'template': 'dashboard_mockup.html'},
